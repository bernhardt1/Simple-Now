const images = {
  background0: require('./img/background5.png'),
  background1: require('./img/background5.png'),
  background2: require('./img/background5.png'),
  background3: require('./img/background5.png'),
  background4: require('./img/background5.png'),
